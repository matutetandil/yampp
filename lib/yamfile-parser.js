...
function peg$parse(input, options) {
  ...
  const peg$e16 = peg$literalExpectation("var", false);
  const peg$e17 = peg$literalExpectation("env", false);
  const peg$e18 = peg$literalExpectation("__", false);
  ...
  const peg$e42 = peg$literalExpectation("n", false);
  const peg$e43 = peg$literalExpectation("r", false);
  const peg$e44 = peg$literalExpectation("t", false);
  ...
  function peg$f31(line) {    return line;  }
  function peg$f32() {    return null;  }
  function peg$f33(type, name, value) {
  ...
  function peg$f35(functionName, params) {
    return {
  ...
  function peg$f36(str) {    return { type: 'string', value: str };  }
  function peg$f37(arr) {    return { type: 'array', value: arr };  }
  function peg$f38(params) {    return { type: 'params', value: params };  }
  function peg$f39(name) {    return { type: 'variable', name: name };  }
  function peg$f40(chars) {    return { type: 'identifier', value: chars.join('') };  }
  function peg$f41(first, rest) {    return first + rest.join('');  }
  function peg$f42(first, rest) {
    const options = [first];
    for (const r of rest) {
      options.push(r[3]);
    }
  ...
  function peg$f43(params) {    return params || [];  }
  ...
  function peg$f45(name) {    return { type: 'variable', name: name };  }
  function peg$f46(value) {    return { type: 'literal', value: value };  }
  ...
  function peg$f50(content) {    return "{" + (content || "") + "}";  }
  function peg$f51() {    return "\n";  }
  function peg$f52() {    return "\r";  }
  function peg$f53(type, name, value) {
    return makeVariable(type, name, value, location);
  }
  ...
  function peg$f57(cmd) {    return "$(" + cmd + ")";  }
  ...
  function peg$f64(sequence) {    return sequence;  }
  ...
  function peg$f70(first, rest) {    return first + rest.join('');  }
