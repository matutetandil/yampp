...
export type StartRuleNames = "Yamfile";
export interface ParseOptions<T extends StartRuleNames = "Yamfile"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Yamfile">>(
  input: string,
  options?: Options,
): any;
