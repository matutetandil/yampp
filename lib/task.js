export class Task {
  constructor({ name, modifiers = [], dependencies = [], commands = [], lineNumber = null, parameters = [], dependencyParams = {}, watchedFiles = [], localVariables = new Map(), localConstants = new Map(), calls = [] }) {
    this.name = name;
